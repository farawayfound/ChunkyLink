...
cases = [
    ...
    ("oldest: 'when did X start'",
     "When did the Roku playback issue first start appearing?",
     {"mode": "oldest"}),
    ...
    ("top-n: top 5 with status hint",
     "What are the top 5 open tickets for Roku playback?",
     {"mode": "top", "limit": 5}),
    ...
    ("ticket_type: dpstriage explicit",
     "Show all DPSTRIAGE tickets for Xumo freezing",
    ...
    ("difficult: 'how many' + 'this week'",
     "How many tickets were opened this week for Roku?",
     {"mode": "count", "since": 1}),
    ...
    ("difficult: count + 'number of' phrasing variant",
     "What's the number of cases opened for Xumo freezing this month?",
     {"mode": "count", "since": 1}),
