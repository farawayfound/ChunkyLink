...
export function About() {
  return (
    <div className="about-page">
      <SnapIn from="top" delay={0}>
        <h2>About ChunkyPotato</h2>
      </SnapIn>

      <div className="about-panel">
        <SnapIn from="left" delay={60}>
